...
//    Properties ______________________________________________________
     this.url = "assets/js/libs/utilities/";
    //this.url = "effects/";
    ...
    this.laser_eye_left = this.url + "laser-eye-left.png";
    this.laser_eye_right = this.url + "laser-eye-right.png";
    this.imonocle = this.url + "monocle.png";
    this.top_hat = this.url + "top-hat.png";
    this.anime_eye_left = this.url + "anime-eye-left.png";
    this.anime_eye_right = this.url + "anime-eye-right.png";
    this.big_lips = this.url + "big-lips.png";
    this.brow_ring = this.url + "brow-ring.png";
    this.nose_ring = this.url + "nose-ring.png";
    this.bunny_nose = this.url + "bunny-nose.png";
    this.bunny_left_ear = this.url + "bunny-left-ear.png";
    this.bunny_right_ear = this.url + "bunny-right-ear.png";
